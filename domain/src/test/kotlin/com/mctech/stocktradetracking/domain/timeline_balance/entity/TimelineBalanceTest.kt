...
class TimelineBalanceTest {
  ...
  fun `should format final investment balance`() {
    Assertions.assertThat(expectedSingle.getFinalInvestmentBalanceDescription())
      .isEqualTo("R$10.000,00")
    Assertions.assertThat(expectedLinked.getFinalInvestmentBalanceDescription())
      .isEqualTo("R$30.000,00")
    Assertions.assertThat(expectedNeutral.getFinalInvestmentBalanceDescription())
      .isEqualTo("R$0,00")
  }
