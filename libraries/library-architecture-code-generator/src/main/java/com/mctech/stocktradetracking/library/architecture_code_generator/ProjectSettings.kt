...
object ProjectSettings{
    ...
    // ==========================================================================
    val presentationBuildGradle         = StockTradeFeatureGradleModuleTemplate(ModuleDefaultLayers.GeneratedFeature.moduleFile)
    val baseArchitecturePath            = ModuleFilePath(
        moduleLocation = "",
        gradleModuleName = "]",
